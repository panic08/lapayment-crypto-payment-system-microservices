...
public class ClientsTableRecord extends UpdatableRecordImpl<ClientsTableRecord> implements Record13<Integer, String, String, String, Double, Double, Double, Double, Double, Double, Double, Double, String> {
    ...
    @Override
    public Row13<Integer, String, String, String, Double, Double, Double, Double, Double, Double, Double, Double, String> valuesRow() {
    ...
    @Override
    public ClientsTableRecord value1(Integer value) {
        setId(value);
        return this;
    }
    ...
    @Override
    public ClientsTableRecord value13(String value) {
        setRegisteredat(value);
        return this;
    }

    @Override
    public ClientsTableRecord values(Integer value1, String value2, String value3, String value4, Double value5, Double value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, String value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ClientsTableRecord(Integer id, String username, String password, String email, Double btcBalance, Double ethBalance, Double ltcBalance, Double trxBalance, Double tonBalance, Double maticBalance, Double xrpBalance, Double tethererc20Balance, String registeredat) {
        super(ClientsTable.CLIENTS_TABLE);
